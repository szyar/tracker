...
RSpec.describe Issue, type: :model do
  ...
  #       issue = Issue.new(user_id: 3, project_id: 2, summary: '', detail: 'test detail', issue_type: 'Bug',
  #                         priority: 'High', assigned_person: 'user2', status: 'Init')
  #       expect(issue).not_to be_valid
  #     end
  #   end
  #   context 'If the detail is empty' do
  #     it 'Can\'t register an issue without providing detail' do
  #       issue = Issue.new(user_id: 3, project_id: 2, summary: 'test summary', detail: '', issue_type: 'Bug',
  #         priority: 'High', assigned_person: 'user2', status: 'Init')
  #       expect(issue).not_to be_valid
  #     end
  #   end
  ...
  #       issue = Issue.new(user_id: 3, project_id: 2, summary: 'test summary', detail: 'test detail', issue_type: '',
  #                         priority: 'High', assigned_person: 'user2', status: 'Init')
  #       expect(issue).not_to be_valid
  #     end
  #   end
  ...
  #       issue = Issue.new(user_id: 3, project_id: 2, summary: 'test summary', detail: 'test detail', issue_type: 'Bug',
  #                         priority: '', assigned_person: 'user2', status: 'Init')
  #       expect(issue).not_to be_valid
  #     end
  #   end
  ...
  #       issue = Issue.new(user_id: 3, project_id: 2, summary: 'test summary', detail: 'test detail', issue_type: 'Bug',
  #                         priority: 'High', assigned_person: 'user2', status: '')
  #       expect(issue).not_to be_valid
  #     end
  #   end
